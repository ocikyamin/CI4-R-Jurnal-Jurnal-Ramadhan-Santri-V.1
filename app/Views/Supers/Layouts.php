...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url('super')?>">
            ...
            <div class="sidebar-heading">
                ...
                <h6 class="collapse-header">Educational level</h6>
                <?php
                foreach (Master('tm_educate') as $e) {?>
                <a class="collapse-item" href="<?=base_url('super/edu/'.$e['id'])?>"><?=$e['school_name']?></a>
                <?php } ?>
                <a class="collapse-item" href="<?=base_url('super/santri/all')?>">ALL SANTRI</a>
                </div>
                </div>
                </li>
                ...
                <a class="nav-link" href="<?=base_url('super/jurnal/'.date('Y-m-d'))?>">
                <i class="fas fa-fw fa-folder-open"></i>
                <span>Jurnal Santri</span></a>
                </li>

                <li class="nav-item mt-0">
                <a class="nav-link" href="<?=base_url('super/walas/')?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?=base_url('super/logout')?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
    <div class="modalconfirm"></div>
...
$(document).ready(function() {
  ...
  function confirm(id) {
    $.ajax({
      url: "<?=base_url('super/student/confirm')?>",
      data: {id:id},
      dataType: "json",
